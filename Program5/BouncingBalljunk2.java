...
public class BouncingBalljunk2 extends Frame implements WindowListener, ComponentListener, ActionListener, AdjustmentListener, MouseListener, MouseMotionListener, Runnable
{
    // Window constants
    ...
    {
        new BouncingBalljunk2();
    }

    public BouncingBalljunk2()
    {
        setLayout(null);
        setVisible(true);
